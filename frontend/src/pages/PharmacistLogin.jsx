...
import { Package, Mail, Lock, Pill, ArrowLeft, Info } from 'lucide-react';
...
export default function PharmacistLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await login(formData.email, formData.password, 'pharmacist');
        ...
        <div className="auth-card">
          ...
          <div className="auth-footer">
            <div className="admin-note">
              ...
              <span>Contact admin for pharmacist account creation</span>
            </div>
